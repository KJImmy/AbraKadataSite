...
from .views import format_base_view,formats_view,format_pokemon_view,format_teams_view,format_team_breakdown_view,format_cores_view,format_core_breakdown_view
